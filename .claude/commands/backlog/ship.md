...
3. Report the PR back onto this backlog item — REQUIRED, do not skip:
   Call the report_pr_created MCP tool with item_id=08d26342-dc1e-42c5-9c76-5d6f76588e56, pr_url=<the PR URL /github:pr-ship or gh pr create printed>, pr_number=<the PR number>, and summary=<2-3 sentences: what changed and why>.
