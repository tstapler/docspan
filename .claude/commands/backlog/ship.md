...
3. Report the PR back onto this backlog item — REQUIRED, do not skip:
   Call the report_pr_created MCP tool with item_id=3e94f0fe-9fd6-462a-8a32-f869e4969dab, pr_url=<the PR URL /github:pr-ship or gh pr create printed>, pr_number=<the PR number>, and summary=<2-3 sentences: what changed and why>.
