...
3. Report the PR back onto this backlog item — REQUIRED, do not skip:
   Call the report_pr_created MCP tool with item_id=80f68266-9bbc-4791-a1ad-3d8c5663ceeb, pr_url=<the PR URL /github:pr-ship or gh pr create printed>, pr_number=<the PR number>, and summary=<2-3 sentences: what changed and why>.
